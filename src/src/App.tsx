...
import { 
  ...
  DealIcon, CardIcon, MonopolyIcon,
...
const DevelopmentCardsPanel: React.FC<DevelopmentCardsPanelProps> = ({ handlePlayCard, isCollapsed, onToggle }) => {
...
const GameContent: React.FC = () => {
  ...
  const largestArmyPlayerId = (() => {
    ...
    let leaderId: string | null = null;
    players.forEach(p => {
      const kp = p.developmentCards?.KNIGHT || 0;
      if (kp > maxKnights) {
        maxKnights = kp;
        leaderId = p.id;
      }
      ...
      <div className="w-full h-full overflow-y-auto flex flex-col items-center justify-start bg-slate-950 text-slate-100 p-6 relative">
        ...
        <div className="text-center w-full max-w-5xl bg-slate-900 border border-slate-800 p-8 md:p-12 rounded-2xl shadow-xl z-10 flex flex-col items-center my-auto">
          ...
          <div className="w-full max-w-2xl mb-2 text-right">
            ...
            <div className="flex flex-col items-center justify-center mb-8 p-4 bg-slate-900/60 border border-slate-800/80 rounded-xl max-w-md mx-auto">
