...
export function validateShipPlacement(
  ...
  const canConnectAtV1 = hasOwnStructureAtV1 || (touchesShipAtV1 && !v1IsBlocked) || (touchesRoadAtV1 && hasOwnStructureAtV1);
  ...
  const canConnectAtV2 = hasOwnStructureAtV2 || (touchesShipAtV2 && !v2IsBlocked) || (touchesRoadAtV2 && hasOwnStructureAtV2);
