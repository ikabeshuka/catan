...
const rawSeafarers3PlayersFourIslands: HexTile[] = [
  ...
  { id: 'hex_fi3_9', coord: { q: 3, r: -2, s: -1 }, type: 'BRICK', numberToken: 5, hasRobber: false, harbors: [{ type: 'GENERIC', toTileId: 'hex_fi3_15' }] },

  // Row 3
  { id: 'hex_fi3_10', coord: { q: -2, r: -1, s: 3 }, type: 'SHEEP', numberToken: 6, hasRobber: false, harbors: [{ type: 'GENERIC', toTileId: 'hex_fi3_16' }] },
  ...
  { id: 'hex_fi3_22', coord: { q: 3, r: 0, s: -3 }, type: 'WATER', numberToken: null, hasRobber: false, hasPirate: true },

  // Row 5
  { id: 'hex_fi3_23', coord: { q: -3, r: 1, s: 2 }, type: 'WHEAT', numberToken: 11, hasRobber: false, harbors: [{ type: 'WOOD', toTileId: 'hex_fi3_17' }] },
  { id: 'hex_fi3_24', coord: { q: -2, r: 1, s: 1 }, type: 'ORE', numberToken: 8, hasRobber: false },
  { id: 'hex_fi3_25', coord: { q: -1, r: 1, s: 0 }, type: 'WOOD', numberToken: 3, hasRobber: false },
  { id: 'hex_fi3_26', coord: { q: 0, r: 1, s: -1 }, type: 'WATER', numberToken: null, hasRobber: false },
  { id: 'hex_fi3_27', coord: { q: 1, r: 1, s: -2 }, type: 'BRICK', numberToken: 10, hasRobber: false },
  { id: 'hex_fi3_28', coord: { q: 2, r: 1, s: -3 }, type: 'BRICK', numberToken: 6, hasRobber: false, harbors: [{ type: 'WHEAT', toTileId: 'hex_fi3_21' }] },

  // Row 6
  { id: 'hex_fi3_29', coord: { q: -3, r: 2, s: 1 }, type: 'WOOD', numberToken: 5, hasRobber: false, harbors: [{ type: 'GENERIC', edgeIndex: 4 }] },
  { id: 'hex_fi3_30', coord: { q: -2, r: 2, s: 0 }, type: 'SHEEP', numberToken: 9, hasRobber: false, harbors: [{ type: 'SHEEP', toTileId: 'hex_fi3_35' }] },
  { id: 'hex_fi3_31', coord: { q: -1, r: 2, s: -1 }, type: 'WATER', numberToken: null, hasRobber: false },
  { id: 'hex_fi3_32', coord: { q: 0, r: 2, s: -2 }, type: 'ORE', numberToken: 2, hasRobber: false, harbors: [{ type: 'GENERIC', toTileId: 'hex_fi3_26' }] },
