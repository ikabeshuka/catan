...
const SCENARIO_RULES: Record<SeafarersScenario, React.ReactNode> = {
  ...
  THE_LOST_TRIBE: (
    <>
      <li>את שני היישובים ההתחלתיים והדרכים או הספינות מציבים רק באי המרכזי.</li>
      <li>לא ניתן לבנות יישובים באיים הקטנים, והם אינם מפיקים משאבים.</li>
      <li>בניית ספינה על מתנה מעניקה אסימון קטאן, קלף פיתוח או נמל.</li>
      <li>קלף פיתוח שנאסף כפוף למגבלות הרגילות של קלף חדש.</li>
      <li>נמל שנאסף מוצב מיד ליד יישוב חוף חוקי, או נשמר עד שייווצר מקום חוקי.</li>
      <li>השודד אינו יכול לעבור לאיים הקטנים או לחזור למדבר ההתחלתי לאחר שעזב אותו.</li>
