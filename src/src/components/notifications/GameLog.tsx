...
export const GameLog: React.FC = () => {
  ...
  return (
    <div className="w-full h-48 bg-slate-950/40 backdrop-blur-md border border-slate-800/80 rounded-xl p-4 shadow-2xl flex flex-col">
      <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-widest mb-3 border-b border-slate-800 pb-2 block">
        היסטוריית מהלכים (News Feed)
      </span>
